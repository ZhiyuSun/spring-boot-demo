...
import com.zhiyu.springboot.common.Result;
import com.zhiyu.springboot.common.ResultGenerator;
...
public class ApiController {
    ...
    public Result<Boolean> update(@RequestBody User tempUser) {
        ...
        return ResultGenerator.genSuccessResult(userDao.updateUser(user) > 0);
    }
